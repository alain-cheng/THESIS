...
def annotate(color=(0, 0, 0), size=(400, 400), save_name=None, save_dir=None):
    ...
    """
    # Note: were actually just creating solid 400x400 blocks of color as
    #       the encoding will encompass the entire 400x400 image.
    ...
    if save_dir is not None:
        if save_name is not None:
            ...
            label = Image.new('RGBA', (size[0],size[1]), (color[0], color[1], color[2]))
